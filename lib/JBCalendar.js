...
class JBCalendarWebComponent extends HTMLElement{
    ...
    fillMonthDays(){
        ...
        for(let i=1; i<=dayInMonth; i++){
            ...
            const dayDom = this.createDayDom(i, this.data.selectedYear, this.data.selectedMonth, isToday, isSelected,);
    ...
    createDayDom(dayNumber, year, month, isToday, isSelected){
        //create dom
        const dayDom =  document.createElement('div');
        ...
        // add event listeners
        dayDom.addEventListener('click',()=>{this.select(year,month,dayNumber)})
        return dayDom;
