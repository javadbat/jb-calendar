...
export function renderHTML(): string {
  ...
  <div class="jb-calendar-web-component" part="root">
    <section class="navigator-section" part="navigator">
        <div class="prev-btn arrow-btn" part="arrow-button prev-button" title="${dictionary.get(i18n,"prev")}">
        ...
        <div class="navigator-title" part="navigator-title">
            <span class="month" part="navigator-month"></span>
            <span class="year" part="navigator-year"></span>
            <span class="year-range" part="navigator-year-range"></span>
        </div>
        <div class="next-btn arrow-btn" part="arrow-button next-button" title="${dictionary.get(i18n,"next")}">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fit=""
                preserveAspectRatio="xMidYMid meet">
    ...
    <section class="calendar-section" part="calendar">
        <div class="day-selection-section" part="day-section">
            <div class="week-day-wrapper" part="week-day-wrapper">
            </div>
            <div class="month-day-container" part="month-day-container">
        ...
        <div class="swipe-up-symbol" part="swipe-up">
            <svg class="swipe-up-icon" part="swipe-up-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
